...
import logoImg from "../../imports/___-AppIcon.png";
...
export default function AppDownloadLandingPage() {
  return (
    <div
    ...
    >
      ...
      <div className="relative w-full max-w-sm px-5 py-12 flex flex-col gap-8">
        ...
        >
          ...
          >
            <img src={logoImg} alt="医案通" style={{ width: 78, height: 78, borderRadius: 20 }} />
          </motion.div>
